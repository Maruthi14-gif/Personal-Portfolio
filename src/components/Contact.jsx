  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Palyam Maruthi",
          from_email: form.email,
          to_email: "palyammaaru14@gmail.com",
      ...
      >
        <div className="flex flex-col mb-8">
          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 mt-6">
            ...
            >
              <div className="w-10 h-10 rounded-full bg-black-100 flex items-center justify-center border border-white/10 group-hover:border-purple-500/50 transition-colors">
                <FontAwesomeIcon icon={faEnvelope} className="text-purple-400 group-hover:scale-110 transition-transform" />
              </div>
              <span className="font-medium text-[14px]">palyammaaru14@gmail.com</span>
            </a>
            
            <a
              href="tel:+918499850845"
              className="flex items-center gap-3 text-secondary hover:text-white transition-colors duration-300 group"
            >
              <div className="w-10 h-10 rounded-full bg-black-100 flex items-center justify-center border border-white/10 group-hover:border-purple-500/50 transition-colors">
                <FontAwesomeIcon icon={faPhone} className="text-purple-400 group-hover:rotate-12 transition-transform" />
              </div>
              <span className="font-medium text-[14px]">+91 8499850845</span>
            </a>

            <a
              href="https://github.com/24bcs098-eng"
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-3 text-secondary hover:text-white transition-colors duration-300 group"
            >
              <div className="w-10 h-10 rounded-full bg-black-100 flex items-center justify-center border border-white/10 group-hover:border-purple-500/50 transition-colors">
                <img src={github} alt="github" className="w-6 h-6 object-contain opacity-70 group-hover:opacity-100 transition-opacity" />
              </div>
