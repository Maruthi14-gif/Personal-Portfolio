...
const About = () => {
  ...
  return (
    <>
      ...
      >
        I'm a Maruthi Sunil Potdar. A Full Stack Web developer with experience in
      ...
      <button
        ...
        onClick={() =>
          window.open(
            "https://drive.google.com/file/d/1y2OfrQSBnrELjwOYbctv1voKH7fjwamW/view?usp=drive_link",
            "_blank",
          )
        }
      >
